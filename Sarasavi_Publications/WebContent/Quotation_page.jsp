...
<title>Quotation Page - Sarasavi Publications</title>
...
<div class="main">
 ...
 <center><h2>QUOTATION OF ORDERS<button class="buttonX" style="float: right; margin-top: 10px; max-width: 100px;max-height: 40px;margin-right: 20px;" onclick="goBack()"><span>BACK</span></button> <button class="buttonX" style="float: right; margin-top: 10px; max-width: 100px;max-height: 40px;margin-right: 20px;" onclick="window.location.href='home.jsp'"><span>LOG OUT </span></button></h2></center> 
    ...
    <br><table style="font-size: 13px;" border="1px solid #bfbaba" align="Center" class="table">
        <tr>
            <th ><b><i>Oder Id</i></b></th>
            <th ><b><i>Customer name</i></b></th>
            <th ><b><i>Total</i></b></th>
			<th ><b><i>Address</i></b></th> 
			<th ><b><i>Country</i></b></th> 
			<th ><b><i>City</i></b></th> 			
            <th ><b><i>Zip</i></b></th>
