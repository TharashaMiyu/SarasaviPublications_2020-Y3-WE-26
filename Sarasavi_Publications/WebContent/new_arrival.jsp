		...
		<div class="w3-white">
			...
			<div class="w3-container">
				<jsp:include page="header.jsp"></jsp:include>
						...
						<!-- /# Paste our code here -->
						<section>
						<div class="main" style="background-color:;" margin-right="100px;">
			<div class="container">
...
<br><br><br><br>
	...
	<div class="row">
					...
					<br>
						<div class="col-md-3">
							...
							<a href="book_details.jsp">
								<img src="img/book.jpg" style="height: 150px; width: 100px">
							</a>
								<!--a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp"-->
								<!--button id="close" class="closing" onClick="file:///F:/HCI-Sarasavi/Book_Details_Page.html"><img src="img/book.jpg" style="height: 150px; width: 100px"/></button-->

									<!--img class="" src="book.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt=""-->
								<!--/a--><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
							<a href="book_details3.jsp">
								<img src="img/book14.jpg" style="height: 150px; width: 100px">
							</a>
								<!--a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp"-->
									<!--img class="" src="img/book14.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt=""-->
								<!--/a--><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a href="book_details2.jsp">
								<img src="img/book5.jpg" style="height: 150px; width: 100px">
							</a>
								<!--a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp"-->
								<!--button id="close" class="closing" onClick="file:///F:/HCI-Sarasavi/Book_Details_Page.html"><img src="img/book.jpg" style="height: 150px; width: 100px"/></button-->
						...
						<div class="col-md-3 ">
							<div class="product__info">
								<div class="product__wishlist-compare">
									<h4>Harry Potter and Philosopher's Stone</h4>
								</div>
								<br>
								<div class="product__description">
									<p>Author&nbsp;  : J.K,Rowling</p>
									<p>ISBN No&nbsp;  : 9789559878844</p>
									<p>Availability&nbsp;: In Stock</p>
								</div>
								<br>
							</div>
...
<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book15.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
		...
		<hr>
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book16.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book17.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book18.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book19.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book20.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book21.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
							<div class="product__info">
								<div class="product__wishlist-compare">
									<h4>Duka Dina Jayagath Hapannu</h4>
								</div>
								<br>
								<div class="product__description">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book22.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
							<div class="product__info">
								<div class="product__wishlist-compare">
									<h4>Imihiri Badumaka Amihiri Kathawak</h4>
								</div>
								<br>
								<div class="product__description">
				...
				<!-- Item End --><div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book23.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
				...
				<hr>
					...
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book24.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book25.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book26.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book27.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
							<div class="product__info">
								<div class="product__wishlist-compare">
									<h4>Towards A Stress Free Healthy Life</h4>
								</div>
								<br>
								<div class="product__description">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book28.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book29.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book30.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book31.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
	...
	<div class="row">
					<form action="AnnualView2019_Servlet" method="post">
						<div class="col-md-3">
							<h4 class="card-subtitle mb-2 text-muted">
								<a class="d-flex justify-content-center" href= "http://localhost:8081/Sarasavi_Publications/Sarasavi_this_month_nre_arrivals.jsp">
									<img class="" src="img/book32.jpg" style="height: 150px; width: 100px"	onerror="this.src='https://sarasavi.net/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png'"	alt="">
								</a><br> <br>
							</h4>
						</div>
						<div class="col-md-3 ">
							<div class="product__info">
								<div class="product__wishlist-compare">
									<h4>The Law Relating To Literary And Artise And Creation In Sri Lanka</h4>
								</div>
								<br>
								<div class="product__description">
									<p>Author&nbsp;  : L Alwis</p>
