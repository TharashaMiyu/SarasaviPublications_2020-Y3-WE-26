...
<div class="main">
 ...
 <center><h2>ACCOUNT DETAILS<button class="buttonX" style="float: right; margin-top: 10px; max-width: 100px;max-height: 40px;margin-right: 20px;" onclick="window.location.href='Registerform.jsp'"><span>BACK</span></button> <button class="buttonX" style="float: right; margin-top: 10px; max-width: 100px;max-height: 40px;margin-right: 20px;" onclick="window.location.href='home.jsp'"><span>LOG OUT </span></button></h2></center> 
	...
	%>
     ...
     <form name="" action="">
	 <input type="name" style="font-size: 20px;" name="q" placeholder = "Search here....">
	
     <input style="width:11%;margin-top: 3%;" type="submit" value="search"><br><br>
    </form>
     <table style="font-size: 13px;" border="1px solid #bfbaba" align="Center" class="table">
        <tr>
            <th ><b><i>Book Name</i></b></th>
            <th ><b><i>Author</i></b></th>
            <th ><b><i>ISBN No</i></b></th>
			<th ><b><i>Unit Price</i></b></th> 
			<th ><b><i>Quantity</i></b></th> 
			<th ><b><i>Publisher</i></b></th> 
			<th ><b><i>Total Price</i></b></th> 			
            <th ><b><i>Add To Cart</i></b></th>
             <th ><b><i>Remove</i></b></th>
...
if(query != null)
{
	sql ="select* from sarasavi_catalog_tbl where id like '%"+query+"%' or book_name like '%"+query+"%' or author like '%"+query+"%' or isbn_no  like '%"+query+"%' or unit_price like '%"+query+"%' or quantity like '%"+query+"%' or publisher like '%"+query+"%'  or total_price like '%"+query+"%'";
}
else
{
	sql ="select* from sarasavi_catalog_tbl";
}
...
<td><a href="Cart_page.jsp?id=<%=resultSet.getString("id") %>"><img src="MyAccount_Images/Addtocart.jpg" height="40" width="40"></a></td>
<td><a href="MY_WishlistDelete.jsp?id=<%=resultSet.getString("id") %>"><img src="MyAccount_Images/delete.png" height="40" width="40"></a></td>
</tr>
<%
}
connection.close();
